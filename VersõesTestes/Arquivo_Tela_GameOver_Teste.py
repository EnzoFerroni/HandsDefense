...
class MENU():
    def __init__(self):
        ...
        self.font_start = pygame.font.SysFont('comicsans', 38)
        self.font_menu = pygame.font.SysFont('comicsans', 26)

        # Carregar imagens
        self.capa_image = pygame.image.load('capa3.jpg').convert()
        self.background_menu = pygame.image.load('backgroundMenu.jpg').convert()
    ...
    def gameover(self):
        while True:
            screen.fill((0,0,0))
            self.draw_text("GAME OVER", self.font_start, RED, screen, 350, 50)
